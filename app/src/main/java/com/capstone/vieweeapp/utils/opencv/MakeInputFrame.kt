...
fun makeGrayMat(mImage: Image): Mat? {
    var mGray: Mat? = null
...
fun makeRgbaMat(mImage: Image): Mat? {
    var mRgba = Mat(mImage.width, mImage.height, CvType.CV_8UC4)
//    var mRgba = Mat(720, 960, CvType.CV_8UC4)
